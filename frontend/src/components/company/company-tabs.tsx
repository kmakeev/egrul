...
import { CompanyLicenses } from "./company-licenses";
...
import { Info, Users, FileText, Building2, Building, Clock, Network } from "lucide-react";
  ...
  return (
    <Tabs defaultValue="info" className="w-full">
      <TabsList className="grid w-full grid-cols-7 h-auto p-1">
        ...
        <TabsTrigger value="licenses" className="flex sm:flex-row items-center justify-center gap-1 sm:gap-2 p-1.5 sm:p-3 text-xs sm:text-sm min-h-[2.5rem]">
          <FileText className="h-4 w-4 flex-shrink-0" />
          <span className="hidden lg:inline">Лицензии</span>
          <span className="hidden sm:inline lg:hidden">Лицензии</span>
        </TabsTrigger>
        <TabsTrigger value="branches" className="flex sm:flex-row items-center justify-center gap-1 sm:gap-2 p-1.5 sm:p-3 text-xs sm:text-sm min-h-[2.5rem]">
          <Building className="h-4 w-4 flex-shrink-0" />
          <span className="hidden lg:inline">Филиалы</span>
          <span className="hidden sm:inline lg:hidden">Филиалы</span>
        </TabsTrigger>
      ...
      <TabsContent value="licenses" className="mt-6">
        <CompanyLicenses company={company} />
      </TabsContent>
